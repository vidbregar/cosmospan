...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UptimeArgs) DeepCopyInto(out *UptimeArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.Test != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UptimeArgs.
func (in *UptimeArgs) DeepCopy() *UptimeArgs {
	if in == nil {
		return nil
	}
	out := new(UptimeArgs)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *UptimeArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
