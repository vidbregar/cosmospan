...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*UptimeArgs)(nil), (*config.UptimeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_UptimeArgs_To_config_UptimeArgs(a.(*UptimeArgs), b.(*config.UptimeArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.UptimeArgs)(nil), (*UptimeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_UptimeArgs_To_v1_UptimeArgs(a.(*config.UptimeArgs), b.(*UptimeArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_UptimeArgs_To_config_UptimeArgs(in *UptimeArgs, out *config.UptimeArgs, s conversion.Scope) error {
	out.Test = (*string)(unsafe.Pointer(in.Test))
	return nil
}

// Convert_v1_UptimeArgs_To_config_UptimeArgs is an autogenerated conversion function.
func Convert_v1_UptimeArgs_To_config_UptimeArgs(in *UptimeArgs, out *config.UptimeArgs, s conversion.Scope) error {
	return autoConvert_v1_UptimeArgs_To_config_UptimeArgs(in, out, s)
}

func autoConvert_config_UptimeArgs_To_v1_UptimeArgs(in *config.UptimeArgs, out *UptimeArgs, s conversion.Scope) error {
	out.Test = (*string)(unsafe.Pointer(in.Test))
	return nil
}

// Convert_config_UptimeArgs_To_v1_UptimeArgs is an autogenerated conversion function.
func Convert_config_UptimeArgs_To_v1_UptimeArgs(in *config.UptimeArgs, out *UptimeArgs, s conversion.Scope) error {
	return autoConvert_config_UptimeArgs_To_v1_UptimeArgs(in, out, s)
}
