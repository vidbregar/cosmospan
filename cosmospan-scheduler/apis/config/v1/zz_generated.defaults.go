...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&UptimeArgs{}, func(obj interface{}) { SetObjectDefaults_UptimeArgs(obj.(*UptimeArgs)) })
	return nil
}
...
func SetObjectDefaults_UptimeArgs(in *UptimeArgs) {
	SetDefaults_UptimeArgs(in)
}
